...
**GitHub Pages 루트**(`…/NetWork-IP-Search/`)는 소개용 웹 페이지이고, **지금 읽는 곳**은 **문서**(`/manual/`)입니다. 장치 목록·그래프·Wi‑Fi 화면은 **자기 PC에서 서버**를 실행한 뒤 `http://127.0.0.1:8500` 으로 접속하세요.
:::
...
검은 창에 Flask가 뜨면 브라우저에서 **http://127.0.0.1:8500** 을 엽니다. Wi‑Fi 전용은 **http://127.0.0.1:8500/wifi** 입니다.
...
- 이 PC: `http://127.0.0.1:8500`
- 같은 Wi‑Fi의 휴대폰 등: `http://<이 PC의 IPv4>:8500` (방화벽에서 포트 허용 필요할 수 있음)
